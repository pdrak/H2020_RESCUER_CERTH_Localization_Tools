#ifndef STELLA_VSLAM_OPTIMIZER_G2O_SE3_SHOT_VERTEX_H
#define STELLA_VSLAM_OPTIMIZER_G2O_SE3_SHOT_VERTEX_H
...
#endif // STELLA_VSLAM_OPTIMIZER_G2O_SE3_SHOT_VERTEX_H
