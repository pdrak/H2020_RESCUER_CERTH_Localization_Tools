#ifndef STELLA_VSLAM_CAMERA_BASE_H
...
const std::array<std::string, 4> setup_type_to_string = {{"Monocular", "Stereo", "RGBD", "Equirectangular"}};
...
#endif // STELLA_VSLAM_CAMERA_BASE_H
