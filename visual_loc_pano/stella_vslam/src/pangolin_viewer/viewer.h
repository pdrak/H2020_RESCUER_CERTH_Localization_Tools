...
public:
    ...
    /**
     * Set debug mode for the pangolin viewer instance
     */
...
private:
    ...
    void draw_camera_nonconst(const stella_vslam::Mat44_t & cam_pose_wc, const float width);
